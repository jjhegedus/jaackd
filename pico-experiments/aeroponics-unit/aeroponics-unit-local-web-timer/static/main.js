...
function receivedSystemState(systemState = {}) {
  ...
  document.getElementById('unitName').value = systemState['unitName'];

  if(systemState['scheduleRunning']){
...
function unitNameUpdated(responseJson = {}){
  console.log("unitName responseJson = ");
  console.log(responseJson);
  unitName = responseJson["unitName"];
...
function updateUnitName(){
  console.log("updtedUnitName");
  const jsonData = {
    "action": "updateUnitName",
    "unitName" : document.getElementById("unitName").value
  };

  window.postData(jsonData, unitNameUpdated);
}